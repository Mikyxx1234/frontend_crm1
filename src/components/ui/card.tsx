...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[var(--radius-card)] border border-[var(--glass-border)] bg-[var(--glass-bg-panel)] text-card-foreground shadow-[var(--glass-shadow-sm)] backdrop-blur-md transition-all hover:shadow-[var(--glass-shadow)]",
      className
    )}
    {...props}
  />
