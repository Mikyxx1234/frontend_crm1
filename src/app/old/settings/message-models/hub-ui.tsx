        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                ? "bg-white text-[var(--brand-primary)] shadow-[var(--glass-shadow-sm)] v2-dark:bg-[var(--glass-bg-modal)]"
...
export function HubToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-b border-[var(--glass-border-subtle)] px-4 py-3.5">
      <div className="flex min-w-[240px] flex-1 items-center gap-2.5 rounded-[var(--radius-full)] border border-[var(--glass-border)] bg-[var(--glass-bg-overlay)] px-4 py-2.5 transition-colors focus-within:border-[var(--input-border-focus)] focus-within:bg-white focus-within:ring-[3px] focus-within:ring-[var(--input-ring-focus)] v2-dark:focus-within:bg-[var(--glass-bg-modal)]">
...
/** Painel branco sólido (lista/tabela) — base das abas. */
export function HubPanel({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <div
      className={cn(
        "overflow-hidden rounded-[var(--radius-xl)] border border-[var(--glass-border)] bg-white shadow-[var(--glass-shadow)] v2-dark:bg-[var(--glass-bg-modal)]",
        className,
      )}
    >
      {children}
