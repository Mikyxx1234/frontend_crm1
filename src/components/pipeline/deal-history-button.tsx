  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger
        ...
        className={cn(
          "inline-flex items-center justify-center gap-1.5 rounded-full bg-[var(--glass-bg-base)] px-3 py-1 text-[12px] font-medium text-foreground transition-colors hover:bg-slate-200",
          className,
        )}
      >
