...
export const SETTINGS_NAV: SettingsNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: LayoutList,
        href: "/old/settings/message-models",
        allowedRoles: GESTAO,
      },
      {
        id: "notifications",
        ...
        icon: Bell,
        href: "/old/settings/notifications",
    ...
    items: [
      {
        ...
        icon: LayoutList,
        href: "/old/settings/custom-fields",
        allowedRoles: GESTAO,
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Shuffle,
        href: "/old/settings/distribution",
        allowedRoles: GESTAO,
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Smartphone,
        href: "/old/settings/mobile-layout",
        allowedRoles: GESTAO,
