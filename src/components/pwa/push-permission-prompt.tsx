  ...
  return (
    <div
      className={cn(
        ...
        "rounded-[20px] border border-slate-200 bg-white p-4 shadow-premium",
        "md:hidden",
      )}
      role="dialog"
    ...
    >
      ...
      <div className="flex items-start gap-3 pr-6">
        <div className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-[#06b6d4] text-white shadow-cyan-glow">
          <Bell className="size-5" strokeWidth={2.4} />
        </div>
        <div className="min-w-0 flex-1">
          <p className="font-outfit text-[14px] font-black tracking-tight text-slate-900">
          ...
          <div className="mt-3 flex items-center gap-2">
            <button
              ...
              className={cn(
                ...
                "bg-[#507df1] text-[12px] font-bold text-white",
                "shadow-blue-glow transition-colors hover:bg-[#4466d6] active:scale-[0.97]",
            ...
            <button
              type="button"
              onClick={dismiss}
              className="inline-flex h-9 items-center gap-1.5 rounded-full px-3 text-[12px] font-bold text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700"
            >
