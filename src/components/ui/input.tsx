  ...
  ({ className, type = "text", ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-9 w-full min-w-0 rounded-[10px] border border-white/55 bg-white/55 px-3.5 py-2 text-sm text-foreground shadow-[var(--glass-shadow-sm)] backdrop-blur-sm transition-all outline-none",
