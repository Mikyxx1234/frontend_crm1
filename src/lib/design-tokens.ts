...
export const dt = {
  ...
  chat: {
    bubble: {
      ...
      received:
        "rounded-[var(--radius-input)] rounded-bl-sm border-[0.5px] border-[var(--chat-bubble-received-border)] bg-[var(--chat-bubble-received-bg)] shadow-[0_1px_2px_rgba(17,18,26,0.06)]",
