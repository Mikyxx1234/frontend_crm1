...
/**
 * MobileBottomNavChrome — barra inferior em h-scroll com todos os
 * itens da sidebar (modo Visual Chrome). Usado quando a org ativa
 * `visualChrome` e o usuário é ADMIN/MANAGER.
 */
...
export function MobileBottomNavChrome() {
