...
import { IconTrash as Trash2, IconVariable as Variable } from "@tabler/icons-react";
...
/**
 * VariableNode — set/update de variável do contexto. Accent fuchsia
 * pra distinguir de actions (azul/verde) e de lógica (cyan/orange).
 */
    ...
    <div
      className={cn(
        ...
        selected
          ...
          : "border-slate-100 shadow-[0_4px_16px_-8px_rgba(13,27,62,0.08)] hover:-translate-y-px hover:border-fuchsia-300/50 hover:shadow-[0_10px_30px_-10px_rgba(217,70,239,0.3)]"
      )}
    >
      {data.stepIndex != null && (
      ...
      <div className="flex items-start gap-3 px-3.5 py-3">
        <span className="mt-0.5 flex size-9 shrink-0 items-center justify-center rounded-xl bg-fuchsia-50 text-fuchsia-500 ring-1 ring-fuchsia-100">
      ...
      <Handle
        ...
        className="size-3! border-2! border-white! bg-fuchsia-500!"
      />
    </div>
  );
}
