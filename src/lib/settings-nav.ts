...
export const SETTINGS_NAV: SettingsNavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: LayoutList,
        href: "/v2/settings/message-models",
        allowedRoles: GESTAO,
      },
      {
        id: "notifications",
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Smartphone,
        href: "/v2/settings/mobile-layout",
        allowedRoles: GESTAO,
