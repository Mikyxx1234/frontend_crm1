  ...
  return (
    ...
    >
      <div className="border-b border-slate-100 pb-3">
        <p className="font-heading text-[15px] font-black tracking-tighter text-slate-900">
          Blocos
        </p>
              ...
              return (
                <li key={type}>
                  <button
                    ...
                    className="group/item flex w-full cursor-grab items-center gap-2.5 rounded-xl border border-slate-100 bg-white px-2.5 py-2 text-left transition-all duration-200 hover:-translate-y-px hover:border-brand-blue/30 hover:bg-[#eef4ff]/40 hover:shadow-blue-glow active:cursor-grabbing"
                  >
                    <span
                      className={cn(
                        "flex size-8 shrink-0 items-center justify-center rounded-lg bg-slate-50 ring-1 ring-slate-100 transition-all group-hover/item:scale-105 group-hover/item:bg-white group-hover/item:ring-brand-blue/20",
                        color
                      )}
                    >
                      <Icon className="size-4" />
                    </span>
                    <span className="truncate text-[13px] font-bold tracking-tight text-slate-700">
                      {stepTypeLabel(type)}
                    </span>
                  </button>
                </li>
