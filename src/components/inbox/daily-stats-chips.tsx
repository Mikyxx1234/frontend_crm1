...
const TONE_BG: Record<ChipTone, string> = {
  amber: "bg-[var(--color-warn-bg)] text-[var(--color-warn)] ring-[var(--color-warn)]/70 hover:bg-[var(--color-warn-bg)] dark:bg-[var(--color-warning)]/10 dark:text-[var(--color-warning)] dark:ring-[var(--color-warning)]/30",
  red: "bg-[var(--color-danger-bg)] text-[var(--color-danger-text)] ring-[var(--color-destructive)]/70 hover:bg-[var(--color-danger-subtle)] dark:bg-[var(--color-danger)]/10 dark:text-[var(--color-destructive)] dark:ring-[var(--color-destructive)]/30",
  emerald: "bg-[var(--color-success-bg)] text-[var(--color-success-text)] ring-[var(--color-success)]/70 hover:bg-[var(--color-success-bg)] dark:bg-[var(--color-success)]/10 dark:text-[var(--color-success)] dark:ring-[var(--color-success)]/30",
  slate: "bg-[var(--color-bg-subtle)] text-[var(--color-ink-soft)] ring-[var(--color-border-soft)] hover:bg-[var(--glass-bg-base)] dark:bg-[var(--glass-bg-base)]/50 dark:text-[var(--color-ink-muted)] dark:ring-[var(--color-border-strong)]",
};
