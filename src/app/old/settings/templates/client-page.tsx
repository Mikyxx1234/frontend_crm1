          ...
          grouped.map(([cat, items]) => (
            <div key={cat}>
              ...
              <div className="grid grid-cols-[repeat(auto-fill,minmax(340px,1fr))] gap-3.5 px-[18px] pb-[18px] pt-1.5">
                ...
                >
                  <span className="flex size-10 items-center justify-center rounded-[var(--radius-md)] border border-[var(--glass-border)] bg-white text-[var(--brand-primary)] v2-dark:bg-[var(--glass-bg-modal)]">
...
function InternalTemplateCard({
  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-[var(--radius-lg)] border border-[var(--glass-border)] bg-white shadow-[var(--glass-shadow-sm)] transition-all hover:-translate-y-0.5 hover:border-[var(--input-border-focus)] hover:shadow-[var(--glass-shadow)] v2-dark:bg-[var(--glass-bg-modal)]">
